...
seg_angles = 64
epochs = 200
data_name = '230711-173916' # '221227-001319'
filter_name = '230711-173222'
#=========================================================
save_name = f"{data_name}_{filter_name}_x"  # save_name = f"{data_name}"
...
net = MyNet1(seg_angles=seg_angles, filterdata=filter_data2)
