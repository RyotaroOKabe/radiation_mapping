...
def gen_materials_geometry_tallies(panel_density, e_filter, *energy):
    ...
    #for S3 layer
    min_x3 = openmc.XPlane(x0=-1.5, boundary_type='transmission')     #!20220124
    ...
    assembly.lower_left = [-1 * 3 / 2.0] * 2    #!20220124
    assembly.universes = [[cell_universe] * 3] * 3
    ...
    mesh.dimension = [3, 3] #[10, 10]   #!cell size!
    mesh.lower_left = [-1.5, -1.5] #[-5, -5]  #[-10, -10]    #!cell size!
...
def process_aft_openmc_v1(folder1='random_savearray/', file1='detector_1source_20220118.txt', \
    ...
    mean = fiss['mean'].values.reshape((3, 3)) # numpy array   #!20220626 cell size!
    ...
    stdev = absorb.std_dev.reshape((3, 3))  #!cell size!
    stdev_max = stdev.max()
    #print(stdev)
    ...
    mean_list=mean.T.reshape((1, 9)).tolist() #!cell size!
...
if __name__ == '__main__':
    ...
    dist_min = 100
    dist_max = 100
    folder1='openmc/discrete_3x3_data_20220627_v1/'
    folder2='openmc/discrete_3x3_fig_20220627_v1/'
