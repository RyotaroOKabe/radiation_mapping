...
def gen_materials_geometry_tallies(use_panels, panel_density, e_filter, *energy):
    ...
    plt.show()   #!20220117
    plt.savefig('save_fig/geometry_tetris_T_v1.png')   #!20220117
    plt.close()
...
if __name__ == '__main__':
    ...
    folder1='openmc/disc_filter_tetris_T_data_20220716_v1.3/'
    folder2='openmc/disc_filter_tetris_T_fig_2022716_v1.3/'
    use_panels = ['b', 'd', 'e', 'f']
