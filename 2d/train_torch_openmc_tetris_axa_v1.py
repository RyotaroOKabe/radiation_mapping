...
from dataset_axa_v1 import *  #!20220716
...
if __name__ == '__main__':
    ...
    train_set,test_set=load_data(test_size=50,train_size=None,test_size_gen=None,seg_angles=seg_angles,output_fun=get_output,path=path,source_num=[1],prob=[1.],seed=None)
