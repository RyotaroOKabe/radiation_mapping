...
model_path = 'save_model/model_20220508_openmc_10cm_50000_ep4000_bs256_uniform_new_test_v2.1_model.pt'
...
def main():
    ...
    while SIM_TIME >= time:
        ...
        if step%SIM_STEP==0:
            ...
            #=========================#!20220509
            xdata_original=det_output.reshape(10, 10)
