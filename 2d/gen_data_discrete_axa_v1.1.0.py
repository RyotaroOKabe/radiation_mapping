...
if __name__ == '__main__':
    ...
    folder1=f'openmc/discrete_10x10_{seg_angles}_data_20220803_v1.2/'
    folder2=f'openmc/discrete_10x10_{seg_angles}_fig_20220803_v1.2/'
    ...
    for i in range(num_data):
        ...
        sources_d_th = [[100, float(np.random.randint(0, 360) + np.random.random(1)), source_energies[i]] for i in range(num_sources)]
