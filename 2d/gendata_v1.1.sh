...
#SBATCH --job-name=rad		# a desired name to appear alongside job ID in squeue
...
nice python gen_data_square_v1.py 	# command or script to run; can use 'nvidia-smi' as a test
