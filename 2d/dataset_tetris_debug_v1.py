...
original: dataset_tetris_T_debug_v2.py
    ...
    #def __init__(self, output_fun=get_output,path=path):
        ...
        for filename in files:
            ...
            with open(os.path.join(path,filename),'r') as f:
                ...
                ydata_dict[filename]=output_fun(data['source']) #!20220508
...
class Trainset(object):
    ...
    # def get_one_data(self,source_num,prob):   #!20220716
...
if __name__ == '__main__': #!20220508
    path = 'openmc/discrete_tetris_S_data_20220720_v1'  #!20220716
    filterpath ='openmc/disc_filter_tetris_S_data_20220720_v1.1'    #!20220716
    filterdata=FilterData(filterpath)  
    filterdata2=FilterData2(filterpath)      
    GPU_INDEX = 1#0
    USE_CPU = False
    ...
    #batch_size = 1000
    datas = []
    #train_set,test_set, data_set=load_data(0, source_num=[1])
    train_set,test_set, data_set=load_data(test_size=0,train_size=None,test_size_gen=None,output_fun=get_output,path=path,source_num=[1],prob=[1.],seed=None)
