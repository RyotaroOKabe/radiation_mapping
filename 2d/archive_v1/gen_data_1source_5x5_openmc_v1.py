...
model_path = 'save_model/model_20220626_openmc_5cm_5x5_10000_ep500_bs256_dsc_new_test_v1.1_model.pt'
...
def main():
    ...
    while SIM_TIME >= time:
        ...
        if step%SIM_STEP==0:
            ...
            #=========================#!20220509
            xdata_original=det_output.reshape(5, 5)
