...
def gen_materials_geometry_tallies(panel_density, e_filter, *energy):
    ...
    exc_cell = openmc.Cell(name='exception1', fill=None, region = e2_region)
    ...
    plt.show()   #!20220117
    plt.savefig('save_fig/geometry_tetris_T.png')   #!20220117
    plt.close()
...
if __name__ == '__main__':
    ...
    folder1='openmc/disc_filter_tetris_T_data_20220715_v1.0/'
    folder2='openmc/disc_filter_tetris_T_fig_2022715_v1.0/'
