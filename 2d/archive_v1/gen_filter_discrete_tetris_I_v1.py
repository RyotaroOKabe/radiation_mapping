...
def gen_materials_geometry_tallies(panel_density, e_filter, *energy):
    ...
    assembly.lower_left = [-2, -0.5]  #[-0.5, -2]    #!20220626  # size-change!
    #assembly.universes = [[cell_universe] * 2] * 2  #! size-change!
    assembly.universes = [[cell_universe] * 4] * 1  #! size-change! ([[cell_universe] * num_x] * num_y )
    ...
    plt.show()   #!20220117
    plt.savefig('save_fig/geometry_tetris_I.png')   #!20220117
    plt.close()
    ...
    mesh.dimension = [4, 1] #[1, 4] #[2, 2]   #! size-change!
    mesh.lower_left = [-2, -0.5] #[-0.5, -2]#[-1, -1]  #[-10, -10]     #!20220715   #! size-change!
...
def process_aft_openmc(folder1='random_savearray/', file1='detector_1source_20220118.txt', \
    ...
    mean = fiss['mean'].values.reshape((1, 4))  #reshape((2, 2)) # numpy array   #!20220715   #! size-change!
    ...
    #print(absorb.shape)
    #print("std_dev")
    stdev = absorb.std_dev.reshape((1, 4))  #reshape((2, 2))     #! size-change!
    stdev_max = stdev.max()
    #print(stdev)
...
if __name__ == '__main__':
    ...
    folder1='openmc/disc_filter_tetris_I_data_20220715_v1.1/'
    folder2='openmc/disc_filter_tetris_I_fig_2022715_v1.1/'
