...
def gen_materials_geometry_tallies(panel_density, e_filter, *energy):
    ...
    #for S3 layer
    min_x3 = openmc.XPlane(x0=-2, boundary_type='transmission')     #!20220124
    ...
    assembly.lower_left = [-1 * 4 / 2.0] * 2    #!20220124
    assembly.universes = [[cell_universe] * 4] * 4
    ...
    mesh.dimension = [4, 4] #[10, 10]
    mesh.lower_left = [-2, -2] #[-5, -5]  #[-10, -10]     #!20220124
...
def process_aft_openmc_v1(folder1='random_savearray/', file1='detector_1source_20220118.txt', \
    ...
    mean = fiss['mean'].values.reshape((4,4)) # numpy array   #!20220626
    ...
    stdev = absorb.std_dev.reshape((4, 4))
    stdev_max = stdev.max()
    #print(stdev)
    ...
    mean_list=mean.T.reshape((1, 16)).tolist()
...
if __name__ == '__main__':
    ...
    dist_min = 100
    dist_max = 100
    folder1='openmc/discrete_4x4_data_20220627_v1/'
    folder2='openmc/discrete_4x4_fig_20220627_v1/'
