...
original: gen_openmc_data_discrete_tetrisJLSZ_v1.py
...
if __name__ == '__main__':
    ...
    dist_max = 100
    header = 'data'
    shape_nale_list = ['L', 'Z', 'T']# ['J', 'L', 'Z', 'T', 'S']
    
    for shape_name in shape_nale_list:
        print("shape_name: ", shape_name)
        
        folder1=f'openmc/discrete_tetris_{shape_name}_data_20220717_v1/'
        folder2=f'openmc/discrete_tetris_{shape_name}_fig_20220717_v1/'
