...
from dataset_axa_v2 import *  #!20220716
...
class Filterlayer2(nn.Module):
    """docstring for Filterlayer"""
    #def __init__(self, out_features, filterdata):
    def __init__(self, seg_angles, out_features, filterdata):   #!20220729
        ...
        temp = torch.torch.from_numpy(filterdata.data.reshape((2,seg_angles,-1))) #!20220729
        #print(temp) #!20220305
...
class MyNet2(nn.Module):
    ...
    def __init__(self, seg_angles, filterdata): #!20220729
        ...
        self.l1 = Filterlayer2(seg_angles=seg_angles, out_features=2*seg_angles, filterdata=filterdata) #!20220729
...
if __name__ == '__main__':
    ...
    epochs = 2000
    #=========================================================
    save_name = f"openmc_{a_num}x{a_num}_{num_sources}src_{seg_angles}_ep{epochs}_bs256_20220812_v1.1"      #!20220126
    #=========================================================
    path = 'openmc/discrete_5x5_2src_128_data_20220811_v1.1'  #!20220716
    filterpath ='openmc/disc_filter_5x5_128_data_20220813_v1.1'    #!20220716
