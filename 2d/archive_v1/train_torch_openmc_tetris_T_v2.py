...
class Model(object):
    ...
    def plot_test(self,test,indx, save_name):
        ...
        #plt.figure()
        ax1.plot(np.linspace(-180,180,41)[0:40],test_y[0],label='Simulated')
        ax1.plot(np.linspace(-180,180,41)[0:40],predict_test[0],label='Predicted')
...
if __name__ == '__main__':
    ...
    #=========================================================
    save_name = "openmc_tetris_T_ep100_bs256_20220716_v1.1"      #!20220126
    #=========================================================
