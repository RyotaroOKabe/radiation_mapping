...
if __name__ == '__main__': #!20220508
    ...
    train_set,test_set, data_set=load_data(test_size=0,train_size=None,test_size_gen=None,seg_angles=seg_angles,output_fun=get_output_2source,path=path,source_num=[2],prob=[1.],seed=None)
