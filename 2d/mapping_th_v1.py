...
fig_header = f'A20220912_{a_num}x{a_num}_{num_sources}src_{seg_angles}_v1.1.4'
...
class Map(object):
    ...
    def plot(self,ax=plt.gca(), th=0.1):
        ...
        plt.pcolormesh(X, Y, intensity, cmap=cmap, shading='gouraud')
