...
#from dataset_2x2 import *  #!20220508
from dataset_tetris_T_v2 import *  #!20220716
#from dataset_tetris_T_debug_v1 import *  #!20220716
...
class MyNet2(nn.Module):
    #def __init__(self):
    def __init__(self, filterdata): #!20220716
        ...
        self.l1 = Filterlayer2(out_features=80, filterdata=filterdata) #!20220716
...
if __name__ == '__main__':
    ...
    epochs = 500
    #=========================================================
    save_name = f"tetris{tetris_shape}_ep{epochs}_bs256_20220821_v1.1"      #!20220126
    #=========================================================
    path = f'openmc/discrete_tetris_{tetris_shape}_data_20220720_v1'  #!20220716
    filterpath =f'openmc/disc_filter_tetris_{tetris_shape}_data_20220720_v1.1'    #!20220716
    filter_data2 = FilterData2(filterpath)
    test_size = 50
    #net = MyNet2()
    net = MyNet2(filterdata=filter_data2)
    ...
    train_set,test_set=load_data(test_size=50,train_size=None,test_size_gen=None,output_fun=get_output,path=path,source_num=[1],prob=[1.],seed=None)
    ...
    model.train(optim,train_set,test_set,epochs=epochs,batch_size=256,acc_func=None, verbose=10, save_name=save_name)    #!20220126
