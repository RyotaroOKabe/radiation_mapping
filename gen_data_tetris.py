...
num_data = 300 # the number of the generated data
seg_angles = 64 # The number of angle sectors (resolution: 360 deg/seg_angles)
dist_min = 200   # minimum distance between the radiation source and the detector (cm).
dist_max = 200 #500 # maximum distance between the radiation source and the detector (cm).
