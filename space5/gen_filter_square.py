...
header_dist_particles_dict = {'near': [50, 50000], 'far': [500, 50000]}    # [distance (cm), the number of photon]
...
angle_list = [a*360/num_data -180 for a in range(num_data)]
