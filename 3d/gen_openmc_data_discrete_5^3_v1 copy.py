...
def process_aft_openmc_v1(folder1='random_savearray/', file1='detector_1source_20220118.txt', \
    ...
    axes=[]
    fig=plt.figure(figsize=[20, 4]) #!20220628
    for a in range(5):
        axes.append(fig.add_subplot(1, 5, a+1) )
        plt.imshow(mean[:, :, a], interpolation='nearest', cmap="plasma")       #!20220118
...
if __name__ == '__main__':
    ...
    dist_min = 100
    dist_max = 100
    folder1='openmc/discrete_data_20220629_5^3_v1/'
    folder2='openmc/discrete_fig_20220629_5^3_v1/'
