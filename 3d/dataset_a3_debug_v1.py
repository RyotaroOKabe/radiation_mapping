...
if __name__ == '__main__':
    ...
    for i in range(y_num):
        k = key_list[i]
        y_line = data1_y[i,:,:]
        y_line_sum = torch.sum(y_line).item()
        #print(k + ": "+ str(y_line_sum))
        print(f"{k}: {y_line_sum}")
        if y_line_sum <= 0.0:
            ng_list.append(k)
        #print(y_line)
    #print(data1_y)
...
#-----
    ...
    print('train_len')
    batch_size2=train_set2.data_size
    print(batch_size2)
    #for i in range(num_data):
    data2_x, data2_y, data2_y_ph, data2_y_th=train_set2.get_batch(batch_size2)
    #print('x_shape')
    #print(data2_x.shape)
    #print('y_shape')
    #print(data2_y.shape)
    #print('y_ph_shape')
    #print(data2_y_ph.shape)
    #print('y_th_shape')
    #print(data2_y_th.shape)
    ...
    datas2 = []
    datas2.append((data2_x,data2_y,data2_y_ph,data2_y_th))
    ...
    print("=======The dimension check start!=========")
    print("datay")
    data_set_dict2=Dataset_keys(output_fun=get_output,path=path)
    
    key_list2 = data_set_dict2.keys
    y_num2 = data2_y.shape[0]
    ng_list2 = []
    for j in range(y_num2):
        k2 = key_list2[j]
        y_line2 = data2_y[j,:,:]
        y_line_sum2 = torch.sum(y_line2).item()
        #print(k + ": "+ str(y_line_sum))
        print(f"{k2}: {y_line_sum2}")
        if y_line_sum2 <= 0.0:
            ng_list2.append(k2)
        #print(y_line)
    #print(data1_y)
    ...
    print("ng_list (aft) : " + str(len(ng_list2)))
