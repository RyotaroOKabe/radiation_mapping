...
predictpath = 'predict_test/20220704_predict_5cmxx3_v2.1'
...
model_path = 'save_model/model_openmc_5cmxx3_ep100_bs256_20220704_v2.1_model.pt' #!20220502 out
model =torch.load(model_path)
print(model)    #!20220412

#data_path = 'openmc/data_20220226_1.2'  #!20220502 out
data_path = 'openmc/discrete_data_20220630_5^3_v1'  #!20220502

filterpath ='openmc/disc_filter_data_20220630_5^3_v1'
...
def plot_angle_matrices_pred(data1, output, filename, filterpath, predictpath, filter_types_dict, a_num): #!20220701
    ...
    fig.show()
    fig.savefig(predictpath + '/pred_' + filename[:-4] + "png") #   'random_savefig/abs_rate_20220118_6.png')   #!20220117
    plt.close()
...
def main(a_num):
    ...
    for filename in files:
        ...
        ds, ph, th = filename[:-5].split('_')[-3:]   #!20220704
        ...
        fig.savefig(predictpath + '/xdata_' + filename[:-4] + "png") #   'random_savefig/abs_rate_20220118_6.png')   #!20220117
        plt.close()
        
        filter_types_dict = {'near':20, 'far':100}
        
        plot_angle_matrices_pred(data, predict, filename, filterpath, predictpath, filter_types_dict, a_num)
