...
def gen_materials_geometry_tallies(panel_density, e_filter, *energy):
    ...
    assembly.lower_left = [-1 * 5 / 2.0] * 2    #!20220124
    ...
    mesh.dimension = [5, 5] #[10, 10]
    mesh.lower_left = [-2.5, -2.5] #[-5, -5]  #[-10, -10]     #!20220124
...
def process_aft_openmc_v1(folder1='random_savearray/', file1='detector_1source_20220118.txt', \
    ...
    mean = fiss['mean'].values.reshape((5,5)) # numpy array   #!20220626
...
if __name__ == '__main__':
    ...
    dist_min = 100
    dist_max = 100
    folder1='openmc/discrete_data_20220626_5x5_v2/'
    folder2='openmc/discrete_fig_20220626_5x5_v2/'
