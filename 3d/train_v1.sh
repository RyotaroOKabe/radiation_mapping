...
#SBATCH --job-name=radiation		# a desired name to appear alongside job ID in squeue
...
nice python train_torch_openmc_a3_v1.py 	# command or script to run; can use 'nvidia-smi' as a test
