...
def after_openmc(a_num, rad_dist, rad_phi, rad_th, folder1, folder2):      
...
if __name__ == '__main__':
    ...
    dist_min = 100
    dist_max = 100
    folder1=f'openmc/discrete_data_20220629_{a_num}^3_v1/'
    folder2=f'openmc/discrete_fig_20220629_{a_num}^3_v1/'
    ...
    for i in range(num_data):
        ...
        openmc.run()
        mm = after_openmc(a_num, dist, rad_phi, rad_th, folder1, folder2)
