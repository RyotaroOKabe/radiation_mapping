...
def tensor_types_angles_data(filter_types_dict, phi_list, theta_list, a_num): #!20220701
...
if __name__ == '__main__':
    path = 'openmc/discrete_data_20220630_10^3_v1'    #!20220630
    filterpath ='openmc/disc_filter_data_20220630_10^3_v1'    #!20220630
    ...
    #train_set,test_set=load_data(test_size=100, path=path)
    ...
    #filter_data1 = FilterData(filterpath)
