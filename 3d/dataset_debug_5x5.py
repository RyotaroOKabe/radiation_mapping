...
path = 'openmc/discrete_data_20220626_5x5_v2'    #!20220626
    ...
    def __init__(self, output_fun=get_output,path=path):
        ...
        for filename in files:
            ...
            with open(os.path.join(path,filename),'r') as f:
                ...
                ydata_dict[filename]=get_output(data['source']) #!20220508
...
filterpath ='openmc/disc_filter_data_20220626_v1.1' #!20220626
...
if __name__ == '__main__': #!20220508
    ...
    os.system(f"cp {path} {path}_original") #!20220626
